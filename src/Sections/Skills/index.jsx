    ...
    return(
        <section id='habilidades'>
            ...
            <div className='w-full flex items-center justify-center'>
                ...
                <div className="w-full max-w-3xl grid gap-3 grid-cols-4 items-center justify-items-center max-md:grid-cols-3 max-sm:grid-cols-2 max-sl:grid-cols-1">

                    <div className="div-skills w-full max-w-52 h-40 rounded bg-whitePrimary-light mx-3 mt-6  p-3 flex items-center justify-center flex-col ">
